...
export function barPanel(a: VisionAnalysis): string {
  ...
  return `<section class="bar-section analysis-card" aria-label="Estimated bar path"><div class="section-title"><h2>Follow the bar</h2><span class="micro">${e(model.exerciseName.toUpperCase())} · WRIST-LINE ESTIMATE</span></div><div class="bar-content measured-bar-content">${
    hasPath
      ? `<svg class="measured-bar-path" viewBox="115 15 150 355" role="img" aria-label="Estimated wrist trajectory for ${e(model.exerciseName)} compared against expected trace error margin and athlete silhouette"><path class="figure-silhouette" d="${model.silhouette.legs}" fill="none" stroke-width="12" stroke-linecap="round" stroke-linejoin="round"/><path class="figure-silhouette" d="${model.silhouette.arms}" fill="none" stroke-width="11" stroke-linecap="round" stroke-linejoin="round"/><circle class="figure-silhouette-fill" cx="${model.silhouette.head[0]}" cy="${model.silhouette.head[1]}" r="13"/><path class="figure-axis" d="M194 30V354" stroke-dasharray="3 5" stroke-width="1.2"/><path class="figure-reference figure-reference-fill" d="${model.corridorPath}" fill-opacity="0.12" stroke-opacity="0.3" stroke-width="1" stroke-dasharray="2 3"/><path class="figure-reference" d="${model.refTracePath}" fill="none" stroke-width="2.2" stroke-dasharray="4 4" stroke-linecap="round"/><circle class="figure-reference-fill" cx="${model.refPoints[model.refPoints.length - 1][0]}" cy="${model.refPoints[model.refPoints.length - 1][1]}" r="3.5"/><path class="figure-accent" d="${measuredSvgPath}" fill="none" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>${startDot}${endDot}</svg><div class="bar-path-legend"><span class="legend-badge"><span class="legend-indicator legend-corridor-indicator"></span> Expected trace (± margin)</span><span class="legend-badge"><span class="legend-indicator legend-user-indicator"></span> Your wrist path</span></div>`
